...
# gphp
SRC_GPHP_VAL = join(SRC_FOLDER, "binarytrees.php-3-val.trufflephp")
SRC_GPHP_REF = join(SRC_FOLDER, "binarytrees.php-3-ref.trufflephp")
...
class BenchBinaryTrees(Bench):
    def run_by_ref(self):
        ...
        res.append(self.run_trufflephp(TEST_BY_REF, prefix, SRC_GPHP_REF, ''))
        res.append(self.run_trufflephp_native(TEST_BY_REF, prefix, SRC_GPHP_REF, ''))
    ...
    def run_by_val(self):
        ...
        res.append(self.run_trufflephp(TEST_BY_VAL, prefix, SRC_GPHP_VAL, ''))
        res.append(self.run_trufflephp_native(TEST_BY_VAL, prefix, SRC_GPHP_VAL, ''))
    ...
    def _import_data_manually(self):
        ...
        '/trufflephp-source/benchmarks/scripts-report/measurements/2020-09-02T13:20:38.480351-binarytrees.php-3-val.trufflephp-trufflephp.txt'
...
if __name__ == '__main__':
    bm = BenchBinaryTrees()
    # bm.skip_trufflephp = True
    # bm.skip_trufflephp_native = True
    # bm.run_by_val()
    # bm.run_by_ref()
