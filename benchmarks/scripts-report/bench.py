...
TRUFFLEPHP_HOME = os.environ.get('TRUFFLEPHP_HOME')
if not TRUFFLEPHP_HOME:
    print("[!] TRUFFLEPHP_HOME not set to run trufflephp", flush=True)
    exit(1)

TRUFFLEPHP_BINARY = join(TRUFFLEPHP_HOME, "trufflephp")
if not os.path.exists(TRUFFLEPHP_BINARY):
    print("[!] TRUFFLEPHP_BINARY not found: " + TRUFFLEPHP_BINARY, flush=True)
    exit(1)

TRUFFLEPHP_NATIVE_BINARY = join(TRUFFLEPHP_HOME, "trufflephp-native/trufflephp-native")
if not os.path.exists(TRUFFLEPHP_NATIVE_BINARY):
    print("[!] TRUFFLEPHP_NATIVE_BINARY not found: " + TRUFFLEPHP_NATIVE_BINARY, flush=True)
    exit(1)
...
# JDK 14 path on trufflephp-dev container image
...
# TODO: add support for trufflephp --version
...
class Bench:
    ...
    skip_trufflephp = False
    skip_trufflephp_native = False
    ...
    @staticmethod
    def skip_all():
        Bench.skip_trufflephp = True
        Bench.skip_trufflephp_native = True
        Bench.skip_php = True
    ...
    @staticmethod
    def skip_none():
        Bench.skip_trufflephp = False
        Bench.skip_trufflephp_native = False
    ...
    def run_trufflephp(self, bench, prefix, src, args=''):
        if Bench.skip_trufflephp:
            print("skip_trufflephp=True")
            return None
        return self.run_single_test(bench, prefix, 'trufflephp', TRUFFLEPHP_BINARY, args, src,
                                    binary_version=Bench._get_trufflephp_version(TRUFFLEPHP_BINARY))

    def run_trufflephp_native(self, bench, prefix, src, args=''):
        if Bench.skip_trufflephp_native:
            print("skip_trufflephp_native=True")
            return None
        return self.run_single_test(bench, prefix, 'trufflephp-native', TRUFFLEPHP_NATIVE_BINARY, args, src,
                                    binary_version=Bench._get_trufflephp_version(TRUFFLEPHP_NATIVE_BINARY))
    ...
    @staticmethod
    def _get_trufflephp_version(exec):
        cmd = exec + ' --version'
        return Bench._get_shell_cmd_result(cmd)
