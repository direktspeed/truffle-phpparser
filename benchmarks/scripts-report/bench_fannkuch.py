...
# gphp
SRC_GPHP = join(SRC_FOLDER, "fannkuchredux.php-1.trufflephp")
...
class BenchmarkFannkuch(Bench):
    def run(self):
        ...
        res.append(self.run_trufflephp(TEST, prefix, SRC_GPHP, ''))
        res.append(self.run_trufflephp_native(TEST, prefix, SRC_GPHP, ''))

        self.extract_and_store_data_array(res)

    def _import_data_manually(self):
        '/trufflephp-source/benchmarks/scripts-report/measurements/2020-09-04T07:14:19.014445-fannkuchredux.php-1.php-php.txt'
