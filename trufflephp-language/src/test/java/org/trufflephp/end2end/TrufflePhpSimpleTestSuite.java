...
@RunWith(TRUFFLEPHPTestRunner.class)
@TRUFFLEPHPTestSuite({"tests"})
public class TRUFFLEPHPSimpleTestSuite {
    ...
    public static void main(String[] args) throws Exception {
        ...
        TRUFFLEPHPTestRunner.runInMain(TRUFFLEPHPSimpleTestSuite.class, args);
    }
