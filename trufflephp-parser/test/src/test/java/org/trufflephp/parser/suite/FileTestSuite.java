package org.trufflephp.parser.suite;

import junit.framework.*;
import org.eclipse.php.core.PHPVersion;
import org.eclipse.php.core.ast.nodes.ASTParser;
import org.eclipse.php.core.ast.nodes.Program;
import org.trufflephp.parser.TestUtils;
 ...
 * Runs trufflephp parser and compares produced AST with upstream eclipse parser.
...
public class FileTestSuite extends TestSuite {
    ...
    public static class FileTestCase extends TestCase {
        ...
        protected void runTest() throws Throwable {
            ...
            File actualResultFile = File.createTempFile("trufflephp-output", null);
